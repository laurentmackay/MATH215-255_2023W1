...
A solution to \[y'=f(t,y),\quad \text{with } y(t_0)=y_0\] 
for t  in some interval around $t_0$ if $f(t,y)$ is continuous (as a function of two variables) and $\nicefrac{\partial f}{\partial y}$ exists and is continuous near $(t_0,y_0)$.
...
\vfill
\student{Picard's uniqueness theorem does not apply, because $\pd{f}{y}2\sqrt{|y|}$ does not exist at $y=0$.}
}
